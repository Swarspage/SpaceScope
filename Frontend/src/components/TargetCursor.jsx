...
const TargetCursor = ({
    ...
    // Use refs for quickTo functions to avoid re-creation
    ...
    useEffect(() => {
        ...
        // Initialize quickTo for high performance
        xToRef.current = gsap.quickTo(cursor, "x", { duration: 0.05, ease: "power3" });
        yToRef.current = gsap.quickTo(cursor, "y", { duration: 0.05, ease: "power3" });
