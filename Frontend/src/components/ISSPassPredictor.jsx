...
import { MdSearch, MdMyLocation, MdAccessTime, MdVisibility, MdArrowUpward, MdSouthEast, MdNorthWest } from 'react-icons/md';
...
const ISSPassPredictor = () => {
    ...
    return (
        <div className="bg-[#0a0e17]/90 backdrop-blur-md rounded-xl border border-white/10 p-6 shadow-xl w-full max-w-md">
            ...
            {/* Predictions List */}
            <div className="space-y-3 max-h-60 overflow-y-auto pr-1 scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
